...
// Console.WriteLine("Hello, World!");
 ...
 public class Program
 {
     ...
     private const string blobServiceEndpoint = "https://mediastorderricktest.blob.core.windows.net/";

     //Update the storageAccountName value that you recorded previously in this lab.
     private const string storageAccountName = "mediastorderricktest";

     //Update the storageAccountKey value that you recorded previously in this lab.
     private const string storageAccountKey = "put storage account key here";
    ...
    public static async Task Main(string[] args)
    {
        ...
        // Enumerate the blob containers
        await EnumerateContainersAsync(serviceClient);

        // Create variable to hold the name of the container to enumerate
        string existingContainerName = "raster-graphics";

        // Enumerate the blobs in the specified container
        await EnumerateBlobsAsync(serviceClient, existingContainerName);

        // Create variable to hold the name of the new container
        string newContainerName = "vector-graphics";

        // Create a new container
        BlobContainerClient containerClient = await GetContainerAsync(serviceClient, newContainerName);

        // Create a variable to hold the name of the blob to retrieve
